      ...
      <footer className="movie-footer">
        ...
        <div className="contact-us">
          <div className="contact-card">
            ...
            <a href="mailto:Ohitiin@gmail.com" className="contact-email">
              <svg className="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
